		...
		if(client == null) {
			...
			if(manager == null) {
				...
				if(admin == null) {
					...
					String token = "Basic " + Base64.encodeAsString(admin.getEmail()) + ":" + Base64.encodeAsString(admin.getPassword());
				...
				String token = "Basic " + Base64.encodeAsString(manager.getEmail()) + ":" + Base64.encodeAsString(manager.getPassword());
				Document resp = new Document();
